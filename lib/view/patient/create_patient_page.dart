...
import 'package:doctory/presenter/create_patient_presenter.dart';
...
class CreatePatientPage extends StatefulWidget {
  ...
  final CreatePatientRouteParameter _parameter;

  CreatePatientPage(this._parameter);

  @override
  _CreatePatientPageState createState() => _CreatePatientPageState();
}

class _CreatePatientPageState extends State<CreatePatientPage> with WidgetsBindingObserver implements View {
  ...
  void initState() {
    ...
    _presenter = CreatePatientPresenter(this, widget._parameter.patientList);
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 2,
          centerTitle: true,
          title: Text(AppLocalization.of(context).getTranslatedValue("create_a_new_patient"),
  ...
  void onEntryFailure(BuildContext context) {
    ...
    hideProgressDialog();
    _myWidget.showSnackBar(context, AppLocalization.of(context).getTranslatedValue("failed_to_create_patient_text"),
        Colors.red, 3);
  }
  ...
  Future<void> onEntrySuccess(BuildContext context) async {
    ...
    _myWidget.showSnackBar(context, AppLocalization.of(context).getTranslatedValue("patient_successfully_created_text"),
        Colors.green, 3);
  }
