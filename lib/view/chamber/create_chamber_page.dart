...
class CreateChamberPage extends StatefulWidget {

  final CreateChamberRouteParameter _parameter;

  CreateChamberPage(this._parameter);

  @override
  _CreateChamberPageState createState() => _CreateChamberPageState();
}

class _CreateChamberPageState extends State<CreateChamberPage> with WidgetsBindingObserver implements View {
  ...
  void initState() {
    ...
    _presenter = CreateChamberPresenter(this, widget._parameter.chamberList);
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 2,
          centerTitle: true,
          title: Text(AppLocalization.of(context).getTranslatedValue("create_a_new_chamber"),
  ...
  void onEntryFailure(BuildContext context) {
    ...
    hideProgressDialog();
    _myWidget.showSnackBar(context, AppLocalization.of(context).getTranslatedValue("failed_to_create_chamber_text"),
        Colors.red, 3);
  }
  ...
  Future<void> onEntrySuccess(BuildContext context) async {
    ...
    _myWidget.showSnackBar(context, AppLocalization.of(context).getTranslatedValue("chamber_successfully_created_text"),
        Colors.green, 3);
  }
